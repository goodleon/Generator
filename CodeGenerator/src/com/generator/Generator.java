...
{
  BufferedWriter buffer = getBufferedWriter(path, codeFile.fileName, ".mm");
  try
  {
...
private static void printCallCode(String path, ArrayList<CodeFile> codeList){
  ...
  BufferedWriter mBuff = getBufferedWriter(path, "InitCaller", ".mm");
  try
  {
...
public static void main(String[] args){
  generateCode("/Users/goodleon/Desktop/20191120", 10);
}
}
